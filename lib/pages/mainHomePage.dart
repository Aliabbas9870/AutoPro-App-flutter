                        ...
                        Container(
                          ...
                          child: Column(children: [
                            Container(
                              ...
                              child: Text("Complete protection of your wheels ",
                                  style:
                            ...
                            Container(
                              width: 99,
                              height: 40,
                              child: Image.asset('assets/autopro/tiremax.png'),
                            ),
                            Container(
                                width: 46,
                                decoration: BoxDecoration(
                          ...
                          child: Column(
                            children: [
                              Container(
                                width: 87,
                                height: 110,
                                child: Image.asset('assets/autopro/oilpic.png'),
                              ),
                              Text(
                                'Oil & lubes',
                                style: TextStyle(fontWeight: FontWeight.bold),
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            Container(
                              width: 197,
                              height: 110,
                              child: Image.asset('assets/autopro/image19.png'),
                            ),
                            Text(
                              "Accessories",
                              style: TextStyle(
